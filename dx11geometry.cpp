...
//}
//
//void DX11Geometry::setVertexData(vector<MyVertex::Vertex> &vertices)
//{
...
//
//
//void DX11Geometry::updateVertexData(vector<MyVertex::Vertex> &vertexs)
//{
...
//
//
//void DX11Geometry::updateIndexData(vector<UINT> &indices)
//{
//	D3D11_MAPPED_SUBRESOURCE mappedResource;
//	ZeroMemory(&mappedResource, sizeof(D3D11_MAPPED_SUBRESOURCE));
//	auto d3dContext = gRender->Device()->immediateContext;
...
//
//
//void DX11Geometry::setIndexData(vector<UINT> &indices)
//{
//	tcount = indices.size();
